...
ARG NEXT_PUBLIC_KEYCLOAK_ISSUER_URL
...
ARG NEXT_PUBLIC_ALLOWED_GROUPS

# Make them available during the build
ENV NEXT_PUBLIC_KEYCLOAK_URL=$NEXT_PUBLIC_KEYCLOAK_URL
ENV NEXT_PUBLIC_KEYCLOAK_ISSUER_URL=$NEXT_PUBLIC_KEYCLOAK_ISSUER_URL
ENV NEXT_PUBLIC_KEYCLOAK_REALM=$NEXT_PUBLIC_KEYCLOAK_REALM
ENV NEXT_PUBLIC_KEYCLOAK_CLIENT_ID=$NEXT_PUBLIC_KEYCLOAK_CLIENT_ID
ENV NEXT_PUBLIC_ALLOWED_GROUPS=$NEXT_PUBLIC_ALLOWED_GROUPS
