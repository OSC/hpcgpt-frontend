...
const disclaimer_string = `IMPORTANT: PLEASE READ THIS DISCLAIMER CAREFULLY BEFORE UTILIZING THIS AI-POWERED CHATBOT ("Chatbot") DEVELOPED BY THE Ohio Supercomputer Center (OSC). THE APPLICATION IS OWNED BY THE OHIO SUPERCOMPUTER CENTER (“OSC, "we," "us," or "our"). YOUR ACCESS AND USE OF THE CHATBOT CONSTITUTES YOUR ACKNOWLEDGEMENT AND ACCEPTANCE OF THE TERMS OF THIS DISCLAIMER.
...
2. NO GUARANTEE OF ACCURACY: OSC endeavors to ensure that the information provided by the Chatbot is accurate. However, OSC does not guarantee the accuracy, completeness, or relevance of the information provided. The information may not reflect the most recent updates or changes.
...
4. FEEDBACK AND REPORTING INACCURACIES: We encourage you to provide us feedback on your use of Chatbot and to notify us of any inaccuracies by emailing us at oschelp@osc.edu.
5. LIMITATION OF LIABILITY: Under no circumstances shall OSC be liable for any direct, indirect, incidental, special, consequential, or exemplary damages, including but not limited to, damages for loss of profits, goodwill, use, data, or other intangible losses resulting from the use of or inability to use the Chatbot. 
6. INDEMNIFICATION: You agree to indemnify and hold OSC (including its trustees, fellows, officers, employees, students, and agents) harmless from any claim or demand, including reasonable attorneys’ fees, made by any third party due to or arising out of your use of the Chatbot, your violation of this disclaimer, or your violation of any rights of another. 
7. NO WARRANTIES: The Chatbot is provided on an "as is" and "as available" basis. OSC expressly disclaims all warranties of any kind, whether express or implied, including but not limited to the implied warranties of merchantability, fitness for a particular purpose, and non-infringement. 
8. THIRD-PARTY LINKS: The Chatbot may contain links to third-party websites or services that are not owned or controlled by OSC. OSC has no control over, and assumes no responsibility for, the content, privacy policies, or practices of any third-party websites or services. 
9. GOVERNING LAW: This Disclaimer and any dispute arising out of or related to it is governed and interpreted under the laws of the State of Ohio, excluding its conflict of laws provisions.
10.	Jurisdiction. You agree that all actions or proceedings arising out of or related to your use of Chatbot shall be litigated in courts located within the State of Ohio. All claims against OSC must be filed in accordance with the Ohio Court of Claims Act. You: (a) consents and submits to the jurisdiction of any state court located within OSC and (b) shall not bring any action or claim against OSC in any other jurisdiction.
...
// const depricated_disclaimer_string = `Disclaimer: osc.chat's Chatbot is Imperfect
// Please read this disclaimer carefully before using this website or Chatbot ("Chatbot") provided by https://osc.chat ("we," "us," or "our"). By accessing and using the Chatbot on our website, you acknowledge and agree to the terms of this disclaimer.
