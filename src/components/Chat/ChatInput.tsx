...
export const ChatInput = ({
  ...
  const handleFocus = () => {
    ...
    if (chatInputParentContainerRef.current) {
      chatInputParentContainerRef.current.style.boxShadow = `0 0 0 2px var(--background), 0 0 0 4px var(--osc-orange)`
    }
  }
        ...
        >
          ...
          {!messageIsStreaming &&
            ...
            selectedConversation.messages[
              ...
              <button
                className={`absolute -top-14 left-0 right-0 mx-auto mb-12 flex w-fit items-center gap-3 rounded border border-[--primary] bg-[--primary] px-4 py-2 text-[--osc-white] hover:brightness-110 md:mb-0 md:mt-2`}
                style={{
                  backgroundColor:
